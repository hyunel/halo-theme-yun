...
<head>
    ...
    <script defer src="//cdn.jsdelivr.net/npm/katex@0.12.0/dist/katex.min.js"></script>
    <script defer src="//cdn.jsdelivr.net/npm/katex@0.12.0/dist/contrib/auto-render.min.js" onload="renderMathInElement(document.querySelector('.post-wrapper'),{left:'$$',right:'$$',display: true})"></script>
    </#if>
    ...
    <#--
        公共 head 代码，详情请参考：//docs.halo.run/zh/developer-guide/theme/public-template-tag
...
<#if is_index?? || is_tags??>
<script src="//cdn.jsdelivr.net/npm/wordcloud@1.1.2/src/wordcloud2.min.js"></script>
